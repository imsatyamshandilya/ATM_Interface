...
public class ATM_interface {
    ...
    private static void withdrawMoney(Scanner scanner) {
        ...
        if (amount > 0 && amount <= currentUser.getBalance()) {
            ...
            System.out.println("You can withdraw upto " + currentUser.getBalance() + " only.");
        }
    }
    ...
    private static void transferMoney(Scanner scanner) {
        ...
        if (recipient != null) {
            ...
            if (amount > 0 && amount <= currentUser.getBalance()) {
                ...
                System.out.println("Sorry, Insufficient Balance.");
                System.out.println("You can transfer upto " + currentUser.getBalance() + " only.");
            }
        } else {
